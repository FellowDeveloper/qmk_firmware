...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [MOUSE] = LAYOUT_reviung41(
    U_NP,              RESET,             U_NA,              U_NA,              U_NA,              U_NA,              U_RDO,             KC_BTN1,           KC_MS_U,           KC_BTN2,           KC_PIPE,        U_CPY,
  ...
  [NUM] = LAYOUT_reviung41(
    U_NP,            KC_LBRC,             KC_7,              KC_8,               KC_9,              KC_RBRC,           U_CPY,               KC_MINS,            KC_EQUAL,      KC_UNDS,         KC_PLUS,       U_CPY,
    U_NP,            LGUI_T(KC_SCLN),     KC_4,              KC_5,               LSFT_T(KC_6),      KC_EQL,            U_PST,               KC_LSFT,            KC_LCTL,       KC_LALT,         KC_LGUI,       U_NP,
    U_NP,            KC_GRV,              KC_1,              KC_2,               KC_3,              KC_BSLS,           KC_CUT,              KC_LPRN,            KC_RPRN,       KC_TAB,          KC_CAPS,          U_NP,
